# aRboretum ![](reference/figures/aRboretum_hex_sticker.png)
...
[`arboretum_labels()`](https://DBOSlab.github.io/aRboretum/reference/arboretum_labels.md)
can include them as a slideshow.
...
- In
  [`arboretum_audios()`](https://DBOSlab.github.io/aRboretum/reference/arboretum_audios.md),
  `add_lang` creates one additional folder per species for personal
  audio recording.
- In
  [`arboretum_labels()`](https://DBOSlab.github.io/aRboretum/reference/arboretum_labels.md),
  `add_lang` adds one extra text option to the species label when the
  input data includes non-empty values in the column
