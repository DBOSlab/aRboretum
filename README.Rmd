...
[![CRAN Downloads](https://cranlogs.r-pkg.org/badges/grand-total/aRboretum)](https://cran.r-project.org/package=aRboretum)
...
3. Run `arboretum_audios(..., add_lang = "PANARA")` to create folders for optional personal recordings.
4. Add audio files to the corresponding species folders if desired.
5. Run `arboretum_labels(..., add_lang = "PANARA")` to include the extra language in the generated labels.
